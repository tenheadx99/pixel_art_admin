...
/// Mirror of the app's PixelArt model (pixel_art_app/lib/data/models/
/// pixel_art.dart). The JSON wire format is the shared contract between the
/// app's bundled assets, Firestore artwork docs and this admin panel —
/// keep [toJson]/[fromJson] byte-compatible with the app.
class PixelArt {
  final String id;
  final String name;
  final int gridWidth;
