...
/// Mirror of the app's ImageProcessingService (pixel_art_app/lib/data/
/// services/image_processing_service.dart). The quantization here MUST stay
/// identical to the app's photo importer and tool/build_artworks.py so
/// admin-published artwork is pixel-identical to locally built artwork:
/// BOX/average downscale, 32-step per-channel quantization, top-N colors,
/// alpha < 128 = empty cell, +16 half-step brightening when mapping back.
